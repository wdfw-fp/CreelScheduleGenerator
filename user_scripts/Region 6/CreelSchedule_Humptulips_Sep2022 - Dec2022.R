...
# Sample location(s) 
    ...
    ui_water_bodies<-c("Humptulips River") # Enter the waterbody(s) that will be surveyed (case sensitive and must match water_body listed in lut$water_body
