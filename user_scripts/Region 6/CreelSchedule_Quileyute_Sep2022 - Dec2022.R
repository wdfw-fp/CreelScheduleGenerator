...
# Specify start and end dates for creel survey schedule (format "yyyy-mm-dd")
  ...
  ui_endDate<-as.Date(c("2022-12-15")) 
...
# Sample location(s) 
    ...
    ui_water_bodies<-c("Quillayute River", "Dickey River", "Bogachiel River", "Sol Duc River", "Calawah River") # Enter the waterbody(s) that will be surveyed (case sensitive and must match water_body listed in lut$water_body
